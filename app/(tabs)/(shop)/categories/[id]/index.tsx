...
export default function CategoryDetailsScreen() {
  ...
  const {
    ...
    per_page: 12,
    // هنا يمكنك ربط الـ sort والـ filters من الـ state
  });
  ...
  return (
    <View className="flex-1 bg-background">
      {/* عرض قائمة المنتجات باستخدام FlatList للأداء العالي */}
      <FlatList
        data={products}
        keyExtractor={(item) => item.id.toString()}
        numColumns={2} // عرض شبكي (Grid) بخصائص الموبايل
