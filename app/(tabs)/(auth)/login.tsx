      ...
      >
        ...
        <View className="flex-1 justify-center px-6 py-8">
          ...
          <View className="gap-4">
            ...
            {/* Forgot Password */}
            <Pressable onPress={() => router.push('/(tabs)/(auth)/forgot-password' as any)}>
              <Text className="text-primary text-left">نسيت كلمة المرور؟</Text>
            </Pressable>
