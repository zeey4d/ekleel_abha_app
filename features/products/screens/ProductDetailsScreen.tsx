...
import { ProductTabs } from '@/features/products/components/ProductDetail/ProductTabs';
import { ProductRecommendations } from '@/features/products/components/ProductDetail/ProductRecommendations';
import { ProductViewTracker } from '@/features/products/components/ProductDetail/ProductViewTracker';
  ...
  return (
    <View className="flex-1 bg-background">
      ...
      >
        ...
        {/* Recommendations */}
        <ProductRecommendations productId={product?.id || localizedProduct.id} />
