    ...
    <View className="flex-1 p-4 bg-background">
      ...
      <View className="gap-2 mb-6">
        <View className="flex-row items-center justify-between">
          <Text className="text-xs font-bold text-brand-lavender uppercase tracking-widest">
        ...
        <Text className="text-2xl font-bold text-brand-green leading-tight">
          {product.name}
        </Text>
      ...
      {/* Price Box */}
      <View className="mb-6 p-5 bg-muted/30 rounded-2xl border border-brand-green/5">
          ...
          {isOnSale && (
            <View className="flex-row items-center gap-2">
              ...
              <Badge className="bg-brand-gold">
                <Text className="text-white text-xs">وفر {discountPercentage}%</Text>
              </Badge>
            </View>
          )}
        </View>
      ...
      <View className="h-[1px] bg-border w-full my-6" />
      ...
      <View className="mt-6 flex-row gap-3">
        <View className="flex-1 flex-row items-center gap-2 p-3 rounded-xl border border-border bg-card">
